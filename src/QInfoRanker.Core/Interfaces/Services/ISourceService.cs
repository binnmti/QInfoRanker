...
public interface ISourceService
{
    ...
    Task<IEnumerable<Source>> GetByKeywordIdAsync(int keywordId, CancellationToken cancellationToken = default);
    Task<IEnumerable<Source>> GetTemplateSourcesAsync(CancellationToken cancellationToken = default);
    ...
    Task<IEnumerable<Source>> CreateFromTemplatesAsync(int keywordId, CancellationToken cancellationToken = default);
}
